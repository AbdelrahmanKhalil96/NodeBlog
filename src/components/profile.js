        ...
        axios.post(url, {
            ...
            .then((res) => {
                ...
                if (res.data['DataUpdated']) {
                    this.setState({ message: res.data['DataUpdated'], loading: false })
                }
            })
    }
    handleSubmit = (e) => {
        ...
        this.postContent(this.props.axiosUrl + "/chData", newData);
        if (data.get('newpass')) {
            ...
            this.postContent(this.props.axiosUrl + "/chPass", ndata);
